...
const Home = () =>{
    ...
    return (
        <>
            ...
            <h1 className='text-gray-700 kallisto tracking-wide uppercase animate__animated animate__fadeInUp animate__slow'>
            <AnimatedLetters addClass={'hover:text-gray-400 z-index-10'} letterClass={letterClass} strArray={nameArray} idx={2} />
                
            </h1>
            <h2 className='font-bold kallisto uppercase text-2xl text-gray-600 animate__delay-1s animate__animated animate__fadeIn'>
